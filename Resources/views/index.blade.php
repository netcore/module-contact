...
@section('content')
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr class="object{{ $item->id }}" data-data="{{ $item->toJson() }}">
                                    ...
                                    <td>
                                        <button data-id="{{ $item->id }}" class="btn btn-primary edit-item" data-toggle="modal" data-target="#edit-item">Edit</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">Info block
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">Employee - John Doe</h4>
                </div>
                <div class="panel-body">
                </div>
            </div>
